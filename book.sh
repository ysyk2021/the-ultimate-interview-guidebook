...
ebook-convert the-ultimate-interview-guidebook.epub the-ultimate-interview-guidebook.docx --no-chapters-in-toc --chapter-mark=none --disable-markup-chapter-headings --docx-no-toc --docx-no-cover --docx-page-size=a5 --extra-css page_styles.css
